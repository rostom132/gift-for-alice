...
const defaultHeartImages = Array.from({ length: 19 }, (_, i) => `images/img${i + 1}.JPG`);
...
const ringTexts = [
  'Tiến quý Nhàn lắm',//untuk deskripsi planet layer 1
  "Cười nhiều lên nhé",//untuk deskripsi planet layer 2
  "11/04/2025",//untuk deskripsi planet layer 3
  "Cảm ơn Nhàn nhiều",//untuk deskripsi planet layer 4
...
function createTextRings() {
  ...
  for (let i = 0; i < numRings; i++) {
    ...
    const fontSize = Math.max(130, 0.6 * textureHeight);
...
function preloadGalaxyAudio() {
  const audioSources = [
   "https://youtu.be/2qzcHLyv3N0?si=6G_gaAo176engmyH&t=2"
  ];
